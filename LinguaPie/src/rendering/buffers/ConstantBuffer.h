...
namespace Flame {
  ...
  struct ConstantBuffer final {
    ...
    [[nodiscard]] D3D11_MAPPED_SUBRESOURCE Map(D3D11_MAP mapType) const {
      D3D11_MAPPED_SUBRESOURCE mapping {};
      HRESULT result = DxContext::Get()->d3d11Context->Map(Get(), 0, mapType, 0, &mapping);
    ...
    void Update(const T* data) {
      ...
      DxContext::Get()->d3d11Context->UpdateSubresource(Get(), 0, nullptr, data, 0, 0);
    }

    void Unmap() const {
      DxContext::Get()->d3d11Context->Unmap(Get(), 0);
    }
